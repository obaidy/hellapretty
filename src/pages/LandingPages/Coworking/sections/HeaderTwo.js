...
// Images
import bgImage from "assets/images/bg-eyebrows.JPG";
...
function HeaderTwo() {
  ...
  useEffect(() => {
    const typedJS = new Typed(typedJSRef.current, {
      strings: ["Anti-Age s Masáží", "Ošetření Pleti", "Laminace Obočí"],
      typeSpeed: 70,
      backSpeed: 70,
      backDelay: 200,
      startDelay: 500,
      ...
      >
        <Container>
          ...
          >
            ...
            >
              Komplexní Estetické Centrum <span ref={typedJSRef} />
            </MKTypography>
            <MKTypography variant="body1" color="white" mt={1} mb={6} px={{ xs: 3, lg: 6 }}>
              Natalie is the best.
            </MKTypography>
            <MKButton color="white">Rezervace</MKButton>
          </Grid>
        </Container>
      </MKBox>
    </MKBox>
